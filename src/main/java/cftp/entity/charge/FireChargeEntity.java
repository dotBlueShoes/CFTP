...
public class FireChargeEntity extends AbstractFireChargeEntity {

    private static final float MAX_RENDER_DISTANCE_WHEN_NEWLY_SPAWNED = MathHelper.square(3.5F);
    private int deflectCooldown = 5;

    public FireChargeEntity(EntityType<? extends AbstractFireChargeEntity> entityType, World world) {
        super(entityType, world);
    }

    public FireChargeEntity(PlayerEntity player, World world, double x, double y, double z) {
        super(CFTPEntities.FIRE_CHARGE, world, player, x, y, z);
    }

    public FireChargeEntity(World world, double x, double y, double z, Vec3d velocity) {
        super(CFTPEntities.FIRE_CHARGE, x, y, z, velocity, world);
    }

    @Override
    protected Item getDefaultItem() {
        return CFTPItems.FIRE_CHARGE;
    }

...
public class SurphurCloudEntityRenderer extends EntityRenderer<SulphurEntity, TntEntityRenderState> {

    private final BlockRenderManager blockRenderManager;

    public SurphurCloudEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    ...
    @Override
    public void updateRenderState(SulphurEntity entity, TntEntityRenderState state, float tickDelta) {

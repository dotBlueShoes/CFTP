...
public class EarthChargeEntityRenderer extends EntityRenderer<AbstractEarthChargeEntity, EntityRenderState> {

    private static final Identifier TEXTURE = Identifier.of(CFTP.MOD_ID, "textures/entity/projectiles/earth_charge.png");

    private final WindChargeEntityModel model;

    public EarthChargeEntityRenderer(EntityRendererFactory.Context context) {
        super(context);

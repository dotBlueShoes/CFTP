...
public class FireChargeEntityRenderer extends EntityRenderer<AbstractFireChargeEntity, EntityRenderState> {

    //private static final Identifier TEXTURE = Identifier.ofVanilla("textures/entity/projectiles/wind_charge.png");
    private static final Identifier TEXTURE = Identifier.of(CFTP.MOD_ID, "textures/entity/projectiles/fire_charge.png");

...
public class CreeperPiggyEntity extends CreeperElementalEntity {
    ...
    protected float power = CFTPData.creeperPiggy.power;
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.MAX_HEALTH, CFTPData.creeperPiggy.health)
                .add(EntityAttributes.MOVEMENT_SPEED, CFTPData.creeperPiggy.movementSpeed)
                .add(EntityAttributes.ATTACK_DAMAGE, 1)
                .add(EntityAttributes.FOLLOW_RANGE, CFTPData.creeperPiggy.followRange);
    }

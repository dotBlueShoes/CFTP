...
public class CreeperLightingRenderer extends CreeperElementalRenderer<CreeperLightingEntity> {

    private static final String TEXTURE_PATH = "textures/entity/creeper_lighting.png";

    public CreeperLightingRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

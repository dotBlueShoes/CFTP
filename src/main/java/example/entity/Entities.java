...
public class Entities {
    ...
    public static final EntityType<CreeperCookieEntity> CREEPER_COOKIE = Registry.register(
            ...
            RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(ExampleMod.MOD_ID, "creeper_cookie")),
            EntityType.Builder.create(CreeperCookieEntity::new, SpawnGroup.MONSTER)
                    .dimensions(0.6F, 1.7F)
                    .build(RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(ExampleMod.MOD_ID, "creeper_cookie")))
    );

    public static final EntityType<CreeperLightingEntity> CREEPER_LIGHTING = Registry.register(
            Registries.ENTITY_TYPE,
            RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(ExampleMod.MOD_ID, "creeper_lighting")),
            EntityType.Builder.create(CreeperLightingEntity::new, SpawnGroup.MONSTER)
                    .dimensions(0.6F, 1.7F)
                    .build(RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(ExampleMod.MOD_ID, "creeper_lighting")))
    );

    public static final EntityType<CreeperWaterEntity> CREEPER_WATER = Registry.register(
            Registries.ENTITY_TYPE,
            RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(ExampleMod.MOD_ID, "creeper_water")),
            EntityType.Builder.create(CreeperWaterEntity::new, SpawnGroup.MONSTER)
                    .dimensions(0.6F, 1.7F)
                    .build(RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(ExampleMod.MOD_ID, "creeper_water")))
    );

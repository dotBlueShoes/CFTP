...
public class CreeperBallisticEntity extends CreeperElementalEntity {
    ...
    protected float power = CFTPData.creeperBallistic.power;
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.MAX_HEALTH, CFTPData.creeperBallistic.health)
                .add(EntityAttributes.MOVEMENT_SPEED, CFTPData.creeperBallistic.movementSpeed)
                .add(EntityAttributes.ATTACK_DAMAGE, 1)
                .add(EntityAttributes.FOLLOW_RANGE, CFTPData.creeperBallistic.followRange);
    }
